    ...
    return (
        <section className="g__about-sections">
            ...
            <div className="g_negative-margin cc__intro-wrapper">
                <p className="cc__intro-text g__body-lg">Here is what I have been up to in <span className="cc__intro-text--dev">Development</span>, <span className="cc__intro-text--design">Contracting</span> and <span className="cc__intro-text--learn">Education</span>.</p>
